...
import com.codingbat.java.main.String2;
...
public class String2Test {
    ...
    /*
        ...
        public void countCode() {
            assertEquals(1, string.countHi("aaacodebbb"));
            assertEquals(2, string.countHi("codexxcode"));
            assertEquals(2, string.countHi("cozexxcope"));
            assertEquals(1, string.countHi("cozfxxcope"));
            assertEquals(1, string.countHi("xxcozeyycop"));
            assertEquals(0, string.countHi("cozcop"));
            assertEquals(0, string.countHi("abcxyz"));
            assertEquals(1, string.countHi("code"));
            assertEquals(0, string.countHi("ode"));
            assertEquals(0, string.countHi("c"));
            assertEquals(0, string.countHi(""));
            assertEquals(3, string.countHi("AAcodeBBcoleCCccoreDD"));
            assertEquals(2, string.countHi("AAcodeBBcoleCCccorfDD"));
            assertEquals(3, string.countHi("coAcodeBcoleccoreDD"));
        }
        ...
        public void xyBalance() {
            ...
            assertTrue(string.xyBalance("yxyxyxyx"));
